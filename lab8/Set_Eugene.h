...
private:
    struct BinaryNode
    {
        ...
        BinaryNode* right;
        BinaryNode* parent;
        BinaryNode(const C & elem, BinaryNode* lt, BinaryNode* rt, BinaryNode* par)
...
public:
    ...
    protected:
        ...
        {
            assert(t != nullptr);
            if (t->parent != nullptr && t->parent->right == t)
            {        
                return true;
            }
            else
...
private:
    ...
    BinaryNode* clone1(BinaryNode *t) const
    {
        ...
        {
            return new BinaryNode(t->element, clone1(t->left), clone1(t->right), nullptr);
        }
    }

    void put_parents(BinaryNode* t, BinaryNode* par) const
    {
        if (t == nullptr)
        {
            return;
